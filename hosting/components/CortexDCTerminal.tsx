    ...
    <div className="bg-black text-green-400 font-mono h-screen flex flex-col">
            ...
            <button
              ...
              className={`px-3 py-2 text-xs rounded-lg border transition-colors whitespace-nowrap flex items-center space-x-2 ${
                currentMode === key 
                  ...
                  : 'text-cortex-text-secondary border-gray-600 hover:text-gray-300 hover:border-gray-500'
              }`}
            >
              <span>{mode.icon}</span>
              <span>{mode.name}</span>
      ...
      <div className="bg-gray-800 border-b border-gray-700 px-4 py-2">
        <div className="flex items-center space-x-3 text-sm">
          ...
          <span className="text-cortex-text-secondary">{DC_MODES[currentMode].description}</span>
        </div>
      </div>
